<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = 'mail.promocionesya.com.ar'; //Modificar
		
		
		$mail->Username = 'admin@promocionesya.com.ar'; //Modificar
		$mail->Password = 'bM6hgaTZ'; //Modificar
		
		$mail->setFrom('admin@promocionesya.com.ar', 'Promociones YA'); //Modificar
