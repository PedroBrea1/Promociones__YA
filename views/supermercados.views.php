	...
	<main>
		...
		<div class="menu">
			<ul>
				...
				<li class="intermedio1"><i class="iconomenu fas fa-shopping-cart" style="font-size:1.2vw;"></i><a  href="supermercados.php" style="font-size:1.3vw;"><h4 class="indicador">Supermercados</h4></a>
				</li>
...
<div class="overflow">
		...
		<div class="caja17">
			<div class="fondopromo">
				<h1 class="dias">LUNES Y JUEVES</TABLE></h1>
				<h1 class="numero">30</h1>
				<div class="porc-desc">
				<h1 class="porcentaje">%</h1>
				<h1 class="desc">Desc.</h1>
				</div>
				<img src="basededatos/super/imagenes/licbc.png" class="imgpromo">
				<img src="basededatos/super/imagenes/tvisa.png" class="imgtarjeta41">
				<img src="basededatos/super/imagenes/tmastercard.png" class="imgtarjeta42">
				<h1 class="cond0">3 cuotas sin interés</h1>
				<h1 class="cond1">Exclusivo para quienes depositan sueldo en el banco</h1>
				<h1 class="cond2">Exclusivo compra a través de sitio web o venta telefónica</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>
			<script type="text/javascript">
				function change17(){
		...
		<div class="caja18">
			<div class="fondopromo">
				...
				<img src="basededatos/super/imagenes/licbc.png" class="imgpromo">
				<img src="basededatos/super/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/super/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">3 cuotas sin interés</h1>
				<h1 class="cond2">Exclusivo compra a través de sitio web o venta telefónica</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>
			<script type="text/javascript">
		...
		<div class="caja19">
			<div class="fondopromo">
				...
				<img src="basededatos/super/imagenes/tvisa.png" class="imgtarjeta21">
				<img src="basededatos/super/imagenes/tmastercard.png" class="imgtarjeta22">
				<h1 class="cond1">En un pago</h1>
				<h1 class="cond2">Exclusivo compra presenciales</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>
			<script type="text/javascript">
				function change19(){
		...
		<div class="caja20">
			<div class="fondopromo">
				...
				<img src="basededatos/super/imagenes/lhipotecario.png" class="imgpromo">
				<img src="basededatos/super/imagenes/tvisa.png" class="imgtarjeta31">
				<h1 class="cond1">En un pago</h1>
				<h1 class="cond2">Exclusivo compra a través de sitio web o venta telefónica</h1>
			</div>
