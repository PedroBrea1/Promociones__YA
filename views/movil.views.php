	...
	<main>
		...
		<div class="menu">
			<ul>
				...
				<li class="intermedio3"><i class="iconomenu fas fa-car" style="font-size:1.2vw;"></i><a href="movil.php" style="font-size:1.3vw;"><h4 class="indicador">Movilidad</h4></a>
				</li>
...
<div class="overflow">
		<div class="caja1">
			<div class="fondopromo">
				...
				<img src="basededatos/movil/imagenes/lgalicia.1.jpg" class="imgpromo">
				<img src="basededatos/movil/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/movil/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/movil/imagenes/tamerican.png" class="imgtarjeta33">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 3 cuotas sin interés</h1>
				<h1 class="cond3">Solo con tarjetas de crédito</h1>
			</div>
		...
		<div class="caja2">
			<div class="fondopromo">
				...
				<img src="basededatos/movil/imagenes/lcomafi.jpg" class="imgpromo">
				<img src="basededatos/movil/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/movil/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/movil/imagenes/tdiners.png" class="imgtarjeta33">
				<h1 class="cond1">En artículos de este negocio</h1>
		...
		<div class="caja3">
			<div class="fondopromo">
				...
				<img src="basededatos/movil/imagenes/lhsbc.jpg" class="imgpromo">
				<img src="basededatos/movil/imagenes/tvisa.png" class="imgtarjeta31">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 3 cuotas sin interés</h1>
				<h1 class="cond3">Solo con tarjetas de crédito</h1>
		...
		<div class="caja4">
			<div class="fondopromo">
				...
				<img src="basededatos/movil/imagenes/lciudad.1.jpg" class="imgpromo">
				<img src="basededatos/movil/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/movil/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/movil/imagenes/tcabal.png" class="imgtarjeta33">
				<h1 class="cond1">En artículos de este negocio</h1>
		...
		<div class="caja5">
			<div class="fondopromo">
				...
				<img src="basededatos/movil/imagenes/lnacion.1.png" class="imgpromo">
				<img src="basededatos/movil/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/movil/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 6 cuotas sin interés</h1>
		...
		<div class="caja23">
			<div class="fondopromo">
				...
				<h1 class="cuota">6 cuotas</h1>
				<h1 class="sininteres">sin interés</h1>
				</div>
				<img src="basededatos/movil/imagenes/lgalicia.1.jpg" class="imgpromo">
				<img src="basededatos/movil/imagenes/tvisa.png" class="imgtarjeta21">
				<img src="basededatos/movil/imagenes/tmastercard.png" class="imgtarjeta22">
				<img src="basededatos/movil/imagenes/tamerican.png" class="imgtarjeta23">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Solo con tarjetas de crédito</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>	
			<script type="text/javascript">
				function change23(){
		...
		<div class="caja25">
			<div class="fondopromo">
				...
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 3 cuotas sin interés</h1>
				<h1 class="cond3">Tarjetas de crédito HSBC</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>	
			<script type="text/javascript">
				function change25(){
