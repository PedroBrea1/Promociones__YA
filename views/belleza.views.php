	...
	<main>
		...
		<div class="menu">
			<ul>
				...
				<li class="intermedio2"><i class="iconomenu fas fa-heart" style="font-size:1.2vw;"></i><a href="belleza.php" style="font-size:1.3vw;"><h4 class="indicador">Belleza y Salud</h4></a>
				</li>
	...
	<div class="overflow">
		<div class="caja1">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/lcomafi.jpg" class="imgpromo">
		...
		<div class="caja2">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/lgalicia.1.jpg" class="imgpromo">
				<img src="basededatos/bell/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/bell/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>
		...
		<div class="caja3">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/lciudad.1.jpg" class="imgpromo">
				<img src="basededatos/bell/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/bell/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/bell/imagenes/tcabal.png" class="imgtarjeta33">
				<h1 class="cond1">En artículos de este negocio</h1>
		...
		<div class="caja4">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/lhsbc.jpg" class="imgpromo">
				<img src="basededatos/bell/imagenes/tvisa.png" class="imgtarjeta31">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 3 cuotas sin interés</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
		...
		<div class="caja8">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/bell/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/bell/imagenes/tamerican.png" class="imgtarjeta33">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 3 cuotas sin interés</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja12">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/lnacion.1.png" class="imgpromo">
				<img src="basededatos/bell/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/bell/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 6 cuotas sin interés</h1>
		...
		<div class="caja15">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 12 cuotas sin interés</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>	
			<script type="text/javascript">
		...
		<div class="caja16">
			<div class="fondopromo">
				<h1 class="dias">TODOS LOS DIAS</TABLE></h1>
				<h1 class="numero" style="font-size:4vw;">25</h1>
				<div class="porc-desc">
				<h1 class="porcentaje">%</h1>
				<h1 class="desc">Desc.</h1>
				</div>
		...
		<div class="caja18">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Con tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 28/02/19</h1>	
			<script type="text/javascript">
				function change18(){
		...
		<div class="caja24">
			<div class="fondopromo">
				...
				<img src="basededatos/bell/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Solo en 10 cuotas sin interés</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 28/02/19</h1>	
			<script type="text/javascript">
		...
		<div class="caja30">
			...
			<div class="botonsi" onclick="change30();">
				<a href="#" class="verlocal">Ver negocio</a>
			</div>
		</div>
