	...
	<main>
		...
		<div class="menu">
			...
			<ul>
				...
				<li class="intermedio4"><i class="iconomenu fas fa-brain" style="font-size:1.2vw;"></i><a href="cultura.php" style="font-size:1.3vw;"><h4 class="indicador">Cultura</h4></a>
				</li>				
			</ul>
		</div>
...
<div class="overflow">
		<div class="caja1">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/lcomafi.jpg" class="imgpromo">
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/cultura/imagenes/tmastercard.png" class="imgtarjeta32">
		...
		<div class="caja2">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/lnacion.1.png" class="imgpromo">
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/cultura/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>
		...
		<div class="caja3">
			<div class="fondopromo">
				...
				<h1 class="numero">50</h1>
				<div class="porc-desc">
				<h1 class="porcentaje">%</h1>
				<h1 class="desc">Desc.</h1>
				</div>
				<img src="basededatos/cultura/imagenes/lciudad.1.jpg" class="imgpromo">
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta21">
				<img src="basededatos/cultura/imagenes/tmastercard.png" class="imgtarjeta22">
				<img src="basededatos/cultura/imagenes/tcabal.png" class="imgtarjeta23">
				<h1 class="cond1" >En experiencia en este negocio</h1>
		...
		<div class="caja4">
			<div class="fondopromo">
				<h1 class="dias" >TODOS LOS DIAS</TABLE></h1>
				<div class="cuota-interes2">
				<h1 class="cuota">12 cuotas</h1>
		...
		<div class="caja5">
			<div class="fondopromo">
				<h1 class="dias" >TODOS LOS DIAS</TABLE></h1>
				<h1 class="numero" >2x1</h1>
				<img src="basededatos/cultura/imagenes/lsantander.png" class="imgpromo">
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/cultura/imagenes/tamerican.png" class="imgtarjeta32">
				<h1 class="cond1" >En artículos de este negocio</h1>
				<h1 class="cond2" >En un solo pago</h1>
				<h1 class="cond3" >Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez" >Hasta el 31/12/19</h1>	
			<script type="text/javascript">
				function change5(){
					var image = document.getElementById('social');
					image.src = "imagenes/carguelogo.jpg";
		...
		<div class="caja6">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Tarjetas de crédito y débito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>	
			<script type="text/javascript">
				function change6(){
		...
		<div class="caja7">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/cultura/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/cultura/imagenes/tamerican.png" class="imgtarjeta33">
				<h1 class="cond1">En artículos de este negocio</h1>
				<h1 class="cond2">Hasta 3 cuotas sin interés</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja10">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/cultura/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/cultura/imagenes/tcabal.png" class="imgtarjeta33">
				<h1 class="cond1" >En artículos de este negocio</h1>
				<h1 class="cond2" >En un solo pago</h1>
				<h1 class="cond3" >Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja14">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/lsantander.png" class="imgpromo">
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta21">
				<img src="basededatos/cultura/imagenes/tamerican.png" class="imgtarjeta22">
				<h1 class="cond1" >En este espectáculo</h1>
				<h1 class="cond2" >Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez" >Hasta el 31/03/19</h1>	
			<script type="text/javascript">
		...
		<div class="caja15">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/cultura/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">En esta galería</h1>
				<h1 class="cond2">Hasta 3 cuotas sin interés</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 28/02/19</h1>	
		...
		<div class="caja16">
			...
			<h1 class="validez">Hasta el 01/02/19</h1>	
			<script type="text/javascript">
				function change16(){
					var image = document.getElementById('social');
					image.src = "imagenes/carguelogo.jpg";
		...
		<div class="caja19">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/cultura/imagenes/tcabal.png" class="imgtarjeta33">
				<h1 class="cond1" >Al consumir en este negocio</h1>
				<h1 class="cond2" >En un solo pago</h1>
				<h1 class="cond3" >Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez" >Hasta el 31/01/19</h1>	
		...
		<div class="caja21">
			<div class="fondopromo">
				...
				<img src="basededatos/cultura/imagenes/lciudad.1.jpg" class="imgpromo">
				<img src="basededatos/cultura/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/cultura/imagenes/tcabal.png" class="imgtarjeta32">
				<h1 class="cond1">En artículos de este negocio</h1>			
				<h1 class="cond2">Hasta 3 cuotas sin interés</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
