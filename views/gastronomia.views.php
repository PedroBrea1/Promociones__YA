...
<script>
  ...
  gtag('config', 'UA-130499758-1');
	...
	})(window,document,'script','dataLayer','GTM-KKQWV9F');</script>
...
<body>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KKQWV9F"
	...
	<main>
		...
		<div class="menu">
			<ul>
				...
				<li class="intermedio2"><i class="iconomenu fas fa-utensils" style="font-size:1.2vw;"></i><a href="gastronomia.php" style="font-size:1.3vw;"><h4 class="indicador">Gastronomía</h4></a>
				</li>
...
<div class="overflow">
		<div class="caja1">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/lcomafi.jpg" class="imgpromo">
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tmastercard.png" class="imgtarjeta32">
			...
			<div class="botonsi" onclick="change1();">
				<a href="#" class="verlocal" id="angus">Ver negocio</a>
			</div>		
		</div> 
		...
		<div class="caja2">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/lgalicia.1.jpg" class="imgpromo">
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/gastro/imagenes/tamerican.png" class="imgtarjeta33">
				<h1 class="cond1">Al consumir en este negocio</h1>
				<h1 class="cond2">En un solo pago</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 28/04/19</h1>	
			<script type="text/javascript">
				function change2(){
					var image = document.getElementById('social');
					image.src = "imagenes/carguelogo.jpg";
			...
			<div class="botonsi" onclick="change2();">
				<a href="#" class="verlocal" id="cafemartinez">Ver negocio</a>
			</div>
		</div>
		...
		<div class="caja3">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/lciudad.1.jpg" class="imgpromo">
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">Al consumir en este negocio</h1>
		...
		<div class="caja4">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/gastro/imagenes/tcabal.png" class="imgtarjeta33">
				<h1 class="cond1">Al consumir en este negocio</h1>
				<h1 class="cond2">En un solo pago</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja5">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/lsantander.png" class="imgpromo">
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/gastro/imagenes/tamerican.png" class="imgtarjeta33">
				<h1 class="cond1">Al consumir en este negocio</h1>
		...
		<div class="caja10">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/lsantander.png" class="imgpromo">
				<img src="basededatos/gastro/imagenes/tamerican.png" class="imgtarjeta31">
				<h1 class="cond1">Al consumir en este negocio</h1>
				<h1 class="cond2">En un solo pago</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja12">
			<div class="fondopromo">
				<h1 class="dias">LUNES A JUEVES</TABLE></h1>
				<h1 class="numero">25</h1>
				<div class="porc-desc">
				<h1 class="porcentaje">%</h1>
				<h1 class="desc">Desc.</h1>
				</div>
				<img src="basededatos/gastro/imagenes/lhsbc.jpg" class="imgpromo">
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<h1 class="cond1">15% club la nación black</h1>
				<h1 class="cond2">Más 10% con</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja13">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tmastercard.png" class="imgtarjeta32">
				<img src="basededatos/gastro/imagenes/tdiners.png" class="imgtarjeta33">
				<h1 class="cond1">Al consumir en este negocio</h1>
				<h1 class="cond2">En un solo pago</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja17">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/lnacion.1.png" class="imgpromo">
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">Al consumir en este negocio</h1>
				<h1 class="cond2">En un solo pago</h1>
		...
		<div class="caja20">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/lgalicia.1.jpg" class="imgpromo">
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tamerican.png" class="imgtarjeta32">
				<h1 class="cond1">Al consumir en este negocio</h1>
				<h1 class="cond2">En un solo pago</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja23">
			<div class="fondopromo">
				...
				<img src="basededatos/gastro/imagenes/tvisa.png" class="imgtarjeta31">
				<img src="basededatos/gastro/imagenes/tmastercard.png" class="imgtarjeta32">
				<h1 class="cond1">Dentro del shopping unicenter</h1>
				<h1 class="cond2">En un solo pago</h1>
				<h1 class="cond3">Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 28/02/19</h1>	
		...
		<div class="caja28">
			...
			<div class="botonsi" onclick="change28();">
				<a href="#" class="verlocal">Ver negocio</a>
			</div>
		</div>
		...
		<div class="caja29">
			...
			<div class="botonsi" onclick="change29();">
				<a href="#" class="verlocal">Ver negocio</a>
			</div>
		</div>
