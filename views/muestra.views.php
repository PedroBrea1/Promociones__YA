...
<div class="contenedor">
	...
	<main>
		...
		<div class="menu">
			<ul>
				...
				<li class="intermedio1"><i class="iconomenu fas fa-shopping-cart" style="font-size:1.2vw;"></i><a  href="muestra.php" style="font-size:1.3vw;"><h4 class="indicador">Supermercados</h4></a>
				</li>
				<li class="intermedio1"><i class="fas fa-tshirt" style="font-size:1.2vw;"></i><a href="aviso.php" style="font-size:1.3vw;"><h4>Indumentaria</h4></a>
				</li>
				<li class="intermedio2"><i class="fas fa-utensils" style="font-size:1.2vw;"></i><a href="aviso.php" style="font-size:1.3vw;"><h4>Gastronomía</h4></a>
				</li>
				<li class="intermedio2"><i class="fas fa-heart" style="font-size:1.2vw;"></i><a href="aviso.php" style="font-size:1.3vw;"><h4>Belleza y Salud</h4></a>
				</li>
				<li class="intermedio3"><i class="fas fa-home" style="font-size:1.2vw;"></i><a href="aviso.php" style="font-size:1.3vw;"><h4>Hogar</h4></a>
				</li>
				<li class="intermedio3"><i class="fas fa-car" style="font-size:1.2vw;"></i><a href="aviso.php" style="font-size:1.3vw;"><h4>Movilidad</h4></a>
				</li>
				<li class="intermedio4"><i class="fas fa-brain" style="font-size:1.2vw;"></i><a href="aviso.php" style="font-size:1.3vw;"><h4>Cultura</h4></a>
				</li>				
			</ul>
		</div>
		...
		<div class="pantalla">
			...
			<select class="busca" name="negocio" onchange="location = this.value">
				...
				<option value="empresamuestra.php">Página de muestra</option>
			</select>
	...
	<a href="inicio.php" class="cerrarsesion">Volver atrás</a>

<div class="overflow">
		<div class="caja1">
			<div class="fondopromo">
				<h1 class="dias">LOS MIERCOLES</TABLE></h1>
				<h1 class="numero">20</h1>
				<div class="porc-desc">
				<h1 class="porcentaje">%</h1>
				<h1 class="desc">Desc.</h1>
				</div>
				<img src="basededatos/super/imagenes/lnacion.1.png" class="imgpromo">
				<img src="basededatos/super/imagenes/tvisa.png" class="imgtarjeta21">
				<img src="basededatos/super/imagenes/tmastercard.png" class="imgtarjeta22">
				<h1 class="cond1">En un solo pago</h1>
				<h1 class="cond2">Tarjetas de crédito del banco</h1>
			</div>	
		...
		<div class="caja2">
			<div class="fondopromo">
				...
				<img src="basededatos/super/imagenes/tvisa.png" class="imgtarjeta21">
				<img src="basededatos/super/imagenes/tmastercard.png" class="imgtarjeta22">
				<img src="basededatos/super/imagenes/tcabal.png" class="imgtarjeta23">
				<h1 class="cond1">En un solo pago</h1>
				<h1 class="cond2">Tarjetas de crédito del banco</h1>
			</div>
		...
		<div class="caja4">
			<div class="fondopromo">
				...
				<img src="basededatos/super/imagenes/tmastercard.png" class="imgtarjeta22">
				<h1 class="cond1">En un solo pago</h1>
				<h1 class="cond2">Tarjetas de débito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>	
			<script type="text/javascript">
				function change4(){
		...
		<div class="caja5">
			<div class="fondopromo">
				...
				<img src="basededatos/super/imagenes/lhsbc.jpg" class="imgpromo">
				<h1 class="cond1">En un solo pago</h1>
				<h1 class="cond2">Tarjetas de crédito del banco</h1>
			</div>
			<h1 class="validez">Hasta el 31/01/19</h1>	
		...
		<div class="caja6">
			<div class="fondopromo">
				...
				<img src="basededatos/super/imagenes/lcomafi.jpg" class="imgpromo">
				<img src="basededatos/super/imagenes/tvisa.png" class="imgtarjeta21">
				<img src="basededatos/super/imagenes/tmastercard.png" class="imgtarjeta22">
				<img src="basededatos/super/imagenes/tcabal.png" class="imgtarjeta23">
				<h1 class="cond1">En un solo pago</h1>
		...
		<div class="caja13">
			<div class="fondopromo">
				<h1 class="dias">TODOS LOS LUNES</TABLE></h1>
				<h1 class="numero">15</h1>
				<div class="porc-desc">
				<h1 class="porcentaje">%</h1>
				<h1 class="desc">Desc.</h1>
		...
		<div class="caja16">
			<div class="fondopromo">
				...
				<img src="basededatos/super/imagenes/lcolumbia.png" class="imgpromo">
				<img src="basededatos/super/imagenes/tvisa.png" class="imgtarjeta21">
				<img src="basededatos/super/imagenes/tmastercard.png" class="imgtarjeta22">
				<h1 class="cond1">En un solo pago</h1>
				<h1 class="cond2">Tarjetas de crédito del banco</h1>
